        ...
        {NOTES.map(note => (
          <button key={note} onClick={() => onKeyRoot(keyRoot === note ? null : note)}
            style={{
              ...
              color: keyRoot === note ? 'var(--bg)' : 'rgba(255,255,255,0.45)',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <div style={{
        ...
        <button onClick={isListening ? stopMic : startMic} style={{
          ...
          color: isListening ? '#ff6b6b' : 'var(--bg)',
        ...
        {isListening && (
          <span style={{ fontSize: 11, fontFamily: '"DM Mono", monospace', color: 'var(--accent)', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', lineHeight: 1, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            {!currentChord ? (
              ...
              <>
                <span style={{ fontFamily: '"DM Serif Display", serif', color: 'var(--accent)', lineHeight: 1 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 4, flexWrap: 'wrap' }}>
              {currentNotes.map((n, i) => (
                <span key={i} style={{
                  ...
                  color: 'var(--accent)', background: 'rgba(200,245,90,0.10)',
