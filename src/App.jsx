    ...
    <div style={{ minHeight:'100vh', background:'#0a0a0f', display:'flex', flexDirection:'column', fontFamily:'var(--font-body)', color:'var(--text)' }}>
            ...
            <>
              ...
              {chordHistory.length > 0 && (
                <button onClick={() => setShowSave(true)} style={{
                  ...
                  background:'rgba(200,245,90,0.10)', color:'#c8f55a',
            ...
            <div style={{ display:'flex', gap:8, alignItems:'center', flexWrap:'wrap' }}>
              ...
              {chordHistory.length > 0 && (
                <button onClick={() => setShowSave(true)} style={{
                  padding:'6px 12px', borderRadius:8, fontSize:12, cursor:'pointer',
                  background:'rgba(200,245,90,0.10)', color:'#c8f55a',
                  border:'0.5px solid rgba(200,245,90,0.25)', marginLeft:'auto',
                }}>Save</button>
              )}
            </div>
            {/* Row: smoothing + bpm */}
          ...
          <>
            {!hasFile && !isAnalyzingFile && (
              ...
              >
                ...
                <div style={{ padding:'10px 24px', borderRadius:12, background:'#c8f55a', color:'#0a0a0f', fontSize:13, fontWeight:600 }}>
                  Browse files
                </div>
              </div>
            )}
              ...
              <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:'1.5rem' }}>
                ...
                <div style={{ width:'100%', maxWidth:400 }}>
                  <div style={{ height:6, background:'rgba(255,255,255,0.07)', borderRadius:3, overflow:'hidden' }}>
                    <div style={{ height:'100%', width:`${fileProgress}%`, background:'#c8f55a', borderRadius:3, transition:'width 0.3s ease' }} />
                  </div>
      ...
      {mode === 'file' && hasFile && duration > 0 && (
        <div style={{
          ...
          >
            <div style={{ position:'absolute', top:0, left:0, height:'100%', width:`${pct}%`, background:'#c8f55a', borderRadius:3, pointerEvents:'none' }} />
            <div style={{ position:'absolute', top:'50%', left:`${pct}%`, transform:'translate(-50%,-50%)', width: isMobile?16:13, height: isMobile?16:13, background:'#c8f55a', borderRadius:'50%', pointerEvents:'none' }} />
          </div>
